...
MAIN_REMOTE="git@github.com:secureshadow/solaris-software.git"
SPP_REMOTE="git@github.com:secureshadow/solaris-packet-protocol.git"
SPP_PORTS_REMOTE="git@github.com:secureshadow/spp-ports.git"
